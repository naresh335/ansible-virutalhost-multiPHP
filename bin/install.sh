...
sudo wget https://raw.githubusercontent.com/naresh335/ansible-virutalhost-multiPHP/main/bin/vh -O /usr/local/bin/vh
...
echo "\n\ncopy & modify this command to create virtual host or run '$(tput bold)vh -h$(tput sgr0)' for getting this command during any session\n\n"
